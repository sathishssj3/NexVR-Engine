          ...
          <tr>
            <td style="background-color: #08080B; border-top: 1px solid rgba(255, 255, 255, 0.06); padding: 34px 24px 30px; text-align: center;">
              ...
              <div style="font-family: 'Chakra Petch', sans-serif; font-size: 10px; font-weight: 600; letter-spacing: 0.16em; text-transform: uppercase; margin-bottom: 18px;">
                ...
                <span style="color: rgba(255, 255, 255, 0.15);">·</span>
                <a href="${downloadUrl}" class="footer-link footer-download" style="color: #DC143C !important; text-decoration: none; padding: 4px 10px; font-weight: 700;"><font color="#DC143C" style="color: #DC143C !important;"><span style="color: #DC143C !important;">DOWNLOAD (${version.toUpperCase()})</span></font></a>
              </div>
