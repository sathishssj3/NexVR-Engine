...
#define XR_LIST_ENUM_XrResult(_) \
    ...
    _(XR_ERROR_MESH_DATA_LIMIT_EXCEEDED_ANDROID, -1000462000) \
...
#define XR_LIST_ENUM_XrStructureType(_) \
    ...
    _(XR_TYPE_BODY_TRACKING_FIDELITY_STATUS_META, 1000284000) \
    _(XR_TYPE_SYSTEM_PROPERTIES_BODY_TRACKING_FIDELITY_META, 1000284001) \
    ...
    _(XR_TYPE_SOUND_OBJECT_SHAPE_SPHERE_BD, 1000409004) \
    _(XR_TYPE_SOUND_OBJECT_DISTANCE_ATTENUATION_BD, 1000409005) \
    _(XR_TYPE_SOUND_OBJECT_DISTANCE_ATTENUATION_CURVE_BD, 1000409006) \
    _(XR_TYPE_SOUND_OBJECT_CONFIG_BD, 1000409007) \
    _(XR_TYPE_SOUND_FIELD_CONFIG_BD, 1000409008) \
    _(XR_TYPE_SOUND_FIELD_CHANNEL_DEFINITION_SURROUND_BD, 1000409009) \
    _(XR_TYPE_SOUND_FIELD_CHANNEL_DEFINITION_AMBIX_BD, 1000409010) \
    _(XR_TYPE_SOUND_FIELD_CHANNEL_DEFINITION_FUMA_BD, 1000409011) \
    _(XR_TYPE_SOUND_TRIANGLE_MESH_BD, 1000409012) \
    _(XR_TYPE_SOUND_OBSTACLE_CONFIG_BD, 1000409013) \
    _(XR_TYPE_SOUND_OBSTACLE_MATERIAL_CONFIG_BD, 1000409014) \
    ...
    _(XR_TYPE_SYSTEM_PASSTHROUGH_LAYER_PROPERTIES_ANDROID, 1000462003) \
    _(XR_TYPE_RAYCAST_INFO_ANDROID, 1000463000) \
    _(XR_TYPE_RAYCAST_HIT_RESULTS_ANDROID, 1000463001) \
    _(XR_TYPE_PERFORMANCE_METRICS_STATE_ANDROID, 1000465000) \
    ...
    _(XR_TYPE_SYSTEM_ENVIRONMENT_RAYCAST_PROPERTIES_META, 1000592000) \
    _(XR_TYPE_ENVIRONMENT_RAYCASTER_CREATE_INFO_META, 1000592001) \
    _(XR_TYPE_ENVIRONMENT_RAYCASTER_CREATE_COMPLETION_META, 1000592002) \
    _(XR_TYPE_ENVIRONMENT_RAYCAST_HIT_GET_INFO_META, 1000592003) \
    _(XR_TYPE_ENVIRONMENT_RAYCAST_HIT_META, 1000592004) \
    ...
    _(XR_TYPE_SYSTEM_QR_CODE_TRACKING_PROPERTIES_ANDROID, 1000708000) \
    _(XR_TYPE_TRACKABLE_QR_CODE_CONFIGURATION_ANDROID, 1000708001) \
    _(XR_TYPE_TRACKABLE_QR_CODE_ANDROID, 1000708002) \
    ...
    _(XR_TYPE_SYSTEM_SCENE_MESHING_PROPERTIES_ANDROID, 1000718000) \
    _(XR_TYPE_SCENE_MESHING_TRACKER_CREATE_INFO_ANDROID, 1000718001) \
    _(XR_TYPE_SCENE_MESH_SNAPSHOT_CREATE_INFO_ANDROID, 1000718002) \
    _(XR_TYPE_SCENE_MESH_SNAPSHOT_CREATION_RESULT_ANDROID, 1000718003) \
    _(XR_TYPE_SCENE_SUBMESH_STATE_ANDROID, 1000718004) \
    _(XR_TYPE_SCENE_SUBMESH_DATA_ANDROID, 1000718005) \
...
#define XR_LIST_ENUM_XrObjectType(_) \
    ...
    _(XR_OBJECT_TYPE_SPATIAL_AUDIO_RENDERER_BD, 1000409000) \
    _(XR_OBJECT_TYPE_SOUND_FIELD_BD, 1000409001) \
    _(XR_OBJECT_TYPE_SOUND_OBJECT_BD, 1000409002) \
...
#define XR_LIST_ENUM_XrBodyTrackingFidelityMETA(_) \
    _(XR_BODY_TRACKING_FIDELITY_LOW_META, 1) \
    _(XR_BODY_TRACKING_FIDELITY_HIGH_META, 2) \
    _(XR_BODY_TRACKING_FIDELITY_MAX_ENUM_META, 0x7FFFFFFF)
...
#define XR_LIST_ENUM_XrHandGestureTypeQCOM(_) \
    _(XR_HAND_GESTURE_TYPE_UNKNOWN_QCOM, -1) \
    _(XR_HAND_GESTURE_TYPE_OPEN_HAND_QCOM, 0) \
    _(XR_HAND_GESTURE_TYPE_GRAB_QCOM, 2) \
    _(XR_HAND_GESTURE_TYPE_PINCH_QCOM, 7) \
    _(XR_HAND_GESTURE_TYPE_MAX_ENUM_QCOM, 0x7FFFFFFF)
...
#define XR_LIST_ENUM_XrAudioSampleRateBD(_) \
    ...
    _(XR_AUDIO_SAMPLE_RATE_96000_HZ_BD, 2) \
    _(XR_AUDIO_SAMPLE_RATE_48000_HZ_BD, 3) \
    _(XR_AUDIO_SAMPLE_RATE_44100_HZ_BD, 4) \
    _(XR_AUDIO_SAMPLE_RATE_32000_HZ_BD, 5) \
    _(XR_AUDIO_SAMPLE_RATE_24000_HZ_BD, 6) \
    _(XR_AUDIO_SAMPLE_RATE_22050_HZ_BD, 7) \
    _(XR_AUDIO_SAMPLE_RATE_16000_HZ_BD, 8) \
    _(XR_AUDIO_SAMPLE_RATE_12000_HZ_BD, 9) \
    _(XR_AUDIO_SAMPLE_RATE_11025_HZ_BD, 10) \
    _(XR_AUDIO_SAMPLE_RATE_8000_HZ_BD, 11) \
    _(XR_AUDIO_SAMPLE_RATE_MAX_ENUM_BD, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrAudioBufferChannelLayoutBD(_) \
    _(XR_AUDIO_BUFFER_CHANNEL_LAYOUT_INTERLEAVED_BD, 0) \
    _(XR_AUDIO_BUFFER_CHANNEL_LAYOUT_PLANAR_BD, 1) \
    _(XR_AUDIO_BUFFER_CHANNEL_LAYOUT_MAX_ENUM_BD, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrSoundObjectDistanceAttenuationTypeBD(_) \
    _(XR_SOUND_OBJECT_DISTANCE_ATTENUATION_TYPE_NONE_BD, 0) \
    _(XR_SOUND_OBJECT_DISTANCE_ATTENUATION_TYPE_INVERSE_SQUARE_BD, 1) \
    _(XR_SOUND_OBJECT_DISTANCE_ATTENUATION_TYPE_ROLLOFF_BD, 2) \
    _(XR_SOUND_OBJECT_DISTANCE_ATTENUATION_TYPE_CUSTOMIZED_BD, 100) \
    _(XR_SOUND_OBJECT_DISTANCE_ATTENUATION_TYPE_MAX_ENUM_BD, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrSoundFieldChannelMaskSurroundBD(_) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_FRONT_LEFT_BD, 1) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_FRONT_RIGHT_BD, 2) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_FRONT_CENTER_BD, 4) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_LOW_FREQUENCY_BD, 8) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_BACK_LEFT_BD, 16) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_BACK_RIGHT_BD, 32) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_SIDE_LEFT_BD, 64) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_SIDE_RIGHT_BD, 128) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_TOP_FRONT_LEFT_BD, 256) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_TOP_FRONT_RIGHT_BD, 512) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_TOP_BACK_LEFT_BD, 1024) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_TOP_BACK_RIGHT_BD, 2048) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_BACK_CENTER_BD, 4096) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_TOP_SIDE_LEFT_BD, 8192) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_TOP_SIDE_RIGHT_BD, 16384) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_SETUP_STEREO_BD, 3) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_SETUP_2_1_BD, 11) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_SETUP_3_0_BD, 7) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_SETUP_4_0_BD, 4099) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_SETUP_BACK_SURROUND_BD, 48) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_SETUP_QUAD_BD, 51) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_SETUP_3_1_BD, 15) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_SETUP_5_0_BD, 55) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_SETUP_SIDE_SURROUND_BD, 192) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_SETUP_5_0_SIDE_BD, 199) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_SETUP_5_1_BD, 63) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_SETUP_5_1_SIDE_BD, 207) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_SETUP_7_0_BD, 247) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_SETUP_7_1_BD, 255) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_SETUP_5_1_2_BD, 831) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_SETUP_5_1_4_BD, 3903) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_SETUP_7_1_2_BD, 24831) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_SETUP_7_1_4_BD, 4095) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_SURROUND_MAX_ENUM_BD, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrSoundFieldChannelMaskAmbixBD(_) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_AMBIX_1ST_ORDER_BD, 1) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_AMBIX_2ND_ORDER_BD, 2) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_AMBIX_3RD_ORDER_BD, 3) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_AMBIX_4TH_ORDER_BD, 4) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_AMBIX_5TH_ORDER_BD, 5) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_AMBIX_6TH_ORDER_BD, 6) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_AMBIX_7TH_ORDER_BD, 7) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_AMBIX_MAX_ENUM_BD, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrSoundFieldChannelMaskFumaBD(_) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_FUMA_1ST_ORDER_BD, 1) \
    _(XR_SOUND_FIELD_CHANNEL_MASK_FUMA_MAX_ENUM_BD, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrSoundObstacleMaterialTypeBD(_) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_ACOUSTIC_TILE_BD, 0) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_BRICK_BD, 1) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_BRICK_PAINTED_BD, 2) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_CARPET_BD, 3) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_CARPET_HEAVY_BD, 4) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_CARPET_HEAVY_PADDED_BD, 5) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_CERAMIC_TILE_BD, 6) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_CONCRETE_BD, 7) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_CONCRETE_ROUGH_BD, 8) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_CONCRETE_BLOCK_BD, 9) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_CONCRETE_BLOCK_PAINTED_BD, 10) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_CURTAIN_BD, 11) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_FOLIAGE_BD, 12) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_GLASS_BD, 13) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_GLASS_HEAVY_BD, 14) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_GRASS_BD, 15) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_GRAVEL_BD, 16) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_GYPSUM_BOARD_BD, 17) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_PLASTER_ON_BRICK_BD, 18) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_PLASTER_ON_CONCRETE_BLOCK_BD, 19) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_SOIL_BD, 20) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_SOUND_PROOF_BD, 21) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_SNOW_BD, 22) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_STEEL_BD, 23) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_WATER_BD, 24) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_WOOD_THIN_BD, 25) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_WOOD_THICK_BD, 26) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_WOOD_FLOOR_BD, 27) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_WOOD_ON_CONCRETE_BD, 28) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_CUSTOM_BD, 29) \
    _(XR_SOUND_OBSTACLE_MATERIAL_TYPE_MAX_ENUM_BD, 0x7FFFFFFF)
...
#define XR_LIST_ENUM_XrTrackableTypeANDROID(_) \
    ...
    _(XR_TRACKABLE_TYPE_QR_CODE_ANDROID, 1000708000) \
...
#define XR_LIST_ENUM_XrWindingOrderANDROID(_) \
    _(XR_WINDING_ORDER_UNKNOWN_ANDROID, 0) \
    _(XR_WINDING_ORDER_CW_ANDROID, 1) \
    _(XR_WINDING_ORDER_CCW_ANDROID, 2) \
    _(XR_WINDING_ORDER_MAX_ENUM_ANDROID, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrPerformanceMetricsCounterUnitANDROID(_) \
    _(XR_PERFORMANCE_METRICS_COUNTER_UNIT_GENERIC_ANDROID, 0) \
    _(XR_PERFORMANCE_METRICS_COUNTER_UNIT_PERCENTAGE_ANDROID, 1) \
    _(XR_PERFORMANCE_METRICS_COUNTER_UNIT_MILLISECONDS_ANDROID, 2) \
    _(XR_PERFORMANCE_METRICS_COUNTER_UNIT_BYTES_ANDROID, 3) \
    _(XR_PERFORMANCE_METRICS_COUNTER_UNIT_HERTZ_ANDROID, 4) \
    _(XR_PERFORMANCE_METRICS_COUNTER_UNIT_MAX_ENUM_ANDROID, 0x7FFFFFFF)
...
#define XR_LIST_ENUM_XrSemanticLabelMETA(_) \
    ...
    _(XR_SEMANTIC_LABEL_CEILING_META, 2) \
    _(XR_SEMANTIC_LABEL_WALL_FACE_META, 3) \
    _(XR_SEMANTIC_LABEL_INNER_WALL_FACE_META, 4) \
    _(XR_SEMANTIC_LABEL_INVISIBLE_WALL_FACE_META, 5) \
    _(XR_SEMANTIC_LABEL_DOOR_FRAME_META, 6) \
    _(XR_SEMANTIC_LABEL_WINDOW_FRAME_META, 7) \
    _(XR_SEMANTIC_LABEL_MAX_ENUM_META, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrEnvironmentRaycastHitStatusMETA(_) \
    _(XR_ENVIRONMENT_RAYCAST_HIT_STATUS_HIT_META, 1) \
    _(XR_ENVIRONMENT_RAYCAST_HIT_STATUS_NO_HIT_META, 2) \
    _(XR_ENVIRONMENT_RAYCAST_HIT_STATUS_HIT_POINT_OCCLUDED_META, 3) \
    _(XR_ENVIRONMENT_RAYCAST_HIT_STATUS_HIT_POINT_OUTSIDE_OF_FOV_META, 4) \
...
#define XR_LIST_ENUM_XrQrCodeTrackingModeANDROID(_) \
    _(XR_QR_CODE_TRACKING_MODE_DYNAMIC_ANDROID, 0) \
    _(XR_QR_CODE_TRACKING_MODE_STATIC_ANDROID, 1) \
    _(XR_QRCODE_TRACKING_MODE_MAX_ENUM_ANDROID, 0x7FFFFFFF)
...
#define XR_LIST_ENUM_XrSceneMeshSemanticLabelSetANDROID(_) \
    _(XR_SCENE_MESH_SEMANTIC_LABEL_SET_NONE_ANDROID, 0) \
    _(XR_SCENE_MESH_SEMANTIC_LABEL_SET_DEFAULT_ANDROID, 1) \
    _(XR_SCENE_MESH_SEMANTIC_LABEL_SET_MAX_ENUM_ANDROID, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrSceneMeshTrackingStateANDROID(_) \
    _(XR_SCENE_MESH_TRACKING_STATE_INITIALIZING_ANDROID, 0) \
    _(XR_SCENE_MESH_TRACKING_STATE_TRACKING_ANDROID, 1) \
    _(XR_SCENE_MESH_TRACKING_STATE_WAITING_ANDROID, 2) \
    _(XR_SCENE_MESH_TRACKING_STATE_ERROR_ANDROID, 3) \
    _(XR_SCENE_MESH_TRACKING_STATE_MAX_ENUM_ANDROID, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrSceneMeshSemanticLabelANDROID(_) \
    _(XR_SCENE_MESH_SEMANTIC_LABEL_OTHER_ANDROID, 0) \
    _(XR_SCENE_MESH_SEMANTIC_LABEL_FLOOR_ANDROID, 1) \
    _(XR_SCENE_MESH_SEMANTIC_LABEL_CEILING_ANDROID, 2) \
    _(XR_SCENE_MESH_SEMANTIC_LABEL_WALL_ANDROID, 3) \
    _(XR_SCENE_MESH_SEMANTIC_LABEL_TABLE_ANDROID, 4) \
    _(XR_SCENE_MESH_SEMANTIC_LABEL_MAX_ENUM_ANDROID, 0x7FFFFFFF)
...
#define XR_LIST_BITS_XrSoundObstacleFlagsBD(_) \
    ...
    _(XR_SOUND_OBSTACLE_MESH_BIT_BD, 0x00000004) \
    _(XR_SOUND_OBSTACLE_MATERIALS_BIT_BD, 0x00000008) \

#define XR_LIST_BITS_XrSoundObjectFlagsBD(_) \
    _(XR_SOUND_OBJECT_ENABLED_BIT_BD, 0x00000001) \
    _(XR_SOUND_OBJECT_POSE_BIT_BD, 0x00000002) \
    _(XR_SOUND_OBJECT_DIRECTIVITY_BIT_BD, 0x00000004) \
    _(XR_SOUND_OBJECT_SHAPE_BIT_BD, 0x00000008) \
    _(XR_SOUND_OBJECT_MAIN_VOLUME_BIT_BD, 0x00000010) \
    _(XR_SOUND_OBJECT_REFLECTION_GAIN_BIT_BD, 0x00000020) \
    _(XR_SOUND_OBJECT_ENABLE_DOPPLER_BIT_BD, 0x00000040) \
    _(XR_SOUND_OBJECT_DIRECT_SOUND_ATTENUATION_BIT_BD, 0x00000080) \
    _(XR_SOUND_OBJECT_INDIRECT_SOUND_ATTENUATION_BIT_BD, 0x00000100) \

#define XR_LIST_BITS_XrSoundFieldFlagsBD(_) \
    _(XR_SOUND_FIELD_ENABLED_BIT_BD, 0x00000001) \
    _(XR_SOUND_FIELD_ORIENTATION_BIT_BD, 0x00000002) \
    _(XR_SOUND_FIELD_MAIN_VOLUME_BIT_BD, 0x00000004) \
    _(XR_SOUND_FIELD_LFE_GAIN_BIT_BD, 0x00000008) \
...
#define XR_LIST_BITS_XrPerformanceMetricsCounterFlagsANDROID(_) \
    _(XR_PERFORMANCE_METRICS_COUNTER_ANY_VALUE_VALID_BIT_ANDROID, 0x00000001) \
    _(XR_PERFORMANCE_METRICS_COUNTER_UINT_VALUE_VALID_BIT_ANDROID, 0x00000002) \
    _(XR_PERFORMANCE_METRICS_COUNTER_FLOAT_VALUE_VALID_BIT_ANDROID, 0x00000004) \
...
/// Calls your macro with the name of each member of XrSystemPropertiesBodyTrackingFidelityMETA, in order.
#define XR_LIST_STRUCT_XrSystemPropertiesBodyTrackingFidelityMETA(_) \
    _(type) \
    _(next) \
    _(supportsBodyTrackingFidelity) \

/// Calls your macro with the name of each member of XrBodyTrackingFidelityStatusMETA, in order.
#define XR_LIST_STRUCT_XrBodyTrackingFidelityStatusMETA(_) \
    _(type) \
    _(next) \
    _(fidelity) \
...
/// Calls your macro with the name of each member of XrHandGestureQCOM, in order.
#define XR_LIST_STRUCT_XrHandGestureQCOM(_) \
    _(gesture) \
    _(gestureRatio) \
    _(flipRatio) \
...
/// Calls your macro with the name of each member of XrAudioBufferBD, in order.
#define XR_LIST_STRUCT_XrAudioBufferBD(_) \
    _(type) \
    _(next) \
    _(channelLayout) \
    _(bufferChannels) \
...
/// Calls your macro with the name of each member of XrSoundObjectDirectivityCardioidBD, in order.
#define XR_LIST_STRUCT_XrSoundObjectDirectivityCardioidBD(_) \
    _(type) \
    _(next) \
    _(alpha) \
    _(order) \

/// Calls your macro with the name of each member of XrSoundObjectShapeSphereBD, in order.
#define XR_LIST_STRUCT_XrSoundObjectShapeSphereBD(_) \
    _(type) \
    _(next) \
    _(radius) \

/// Calls your macro with the name of each member of XrAttenuationCurvePointBD, in order.
#define XR_LIST_STRUCT_XrAttenuationCurvePointBD(_) \
    _(distance) \
    _(gain) \

/// Calls your macro with the name of each member of XrSoundObjectDistanceAttenuationCurveBD, in order.
#define XR_LIST_STRUCT_XrSoundObjectDistanceAttenuationCurveBD(_) \
    _(type) \
    _(next) \
    _(curvePointCount) \
    _(curvePoints) \

/// Calls your macro with the name of each member of XrSoundObjectDistanceAttenuationBD, in order.
#define XR_LIST_STRUCT_XrSoundObjectDistanceAttenuationBD(_) \
    _(type) \
    _(next) \
    _(distanceAttenuationType) \
    _(minAttenuationRange) \
    _(maxAttenuationRange) \
    _(referenceDistance) \
    _(rolloffFactor) \
    _(customDistanceAttenuationCurve) \

/// Calls your macro with the name of each member of XrSoundObjectConfigBD, in order.
#define XR_LIST_STRUCT_XrSoundObjectConfigBD(_) \
    _(type) \
    _(next) \
    _(enabled) \
    _(pose) \
    ...
    _(reflectionGain) \
    _(enableDoppler) \
    _(directSoundAttenuation) \
    _(indirectSoundAttenuation) \

/// Calls your macro with the name of each member of XrSoundFieldConfigBD, in order.
#define XR_LIST_STRUCT_XrSoundFieldConfigBD(_) \
    _(type) \
    _(next) \
    _(enabled) \
    _(orientation) \
...
/// Calls your macro with the name of each member of XrSoundFieldChannelDefinitionSurroundBD, in order.
#define XR_LIST_STRUCT_XrSoundFieldChannelDefinitionSurroundBD(_) \
    _(type) \
    _(next) \
    _(channelMask) \

/// Calls your macro with the name of each member of XrSoundFieldChannelDefinitionAmbixBD, in order.
#define XR_LIST_STRUCT_XrSoundFieldChannelDefinitionAmbixBD(_) \
    _(type) \
    _(next) \
    _(channelMask) \

/// Calls your macro with the name of each member of XrSoundFieldChannelDefinitionFumaBD, in order.
#define XR_LIST_STRUCT_XrSoundFieldChannelDefinitionFumaBD(_) \
    _(type) \
    _(next) \
    _(channelMask) \

/// Calls your macro with the name of each member of XrSoundTriangleMeshBD, in order.
#define XR_LIST_STRUCT_XrSoundTriangleMeshBD(_) \
    _(type) \
    _(next) \
    _(vertexCount) \
    _(vertices) \
...
/// Calls your macro with the name of each member of XrSoundObstacleConfigBD, in order.
#define XR_LIST_STRUCT_XrSoundObstacleConfigBD(_) \
    _(type) \
    _(next) \
    _(enabled) \
    _(pose) \
...
/// Calls your macro with the name of each member of XrSoundObstacleMaterialConfigBD, in order.
#define XR_LIST_STRUCT_XrSoundObstacleMaterialConfigBD(_) \
    _(type) \
    _(next) \
    _(materialType) \
    _(bandCount) \
...
/// Calls your macro with the name of each member of XrPassthroughLayerCreateInfoANDROID, in order.
#define XR_LIST_STRUCT_XrPassthroughLayerCreateInfoANDROID(_) \
    _(type) \
    _(next) \
    _(vertexCapacity) \
    _(indexCapacity) \

/// Calls your macro with the name of each member of XrPassthroughLayerMeshANDROID, in order.
#define XR_LIST_STRUCT_XrPassthroughLayerMeshANDROID(_) \
    _(type) \
    _(next) \
    _(windingOrder) \
    _(vertexCount) \
...
/// Calls your macro with the name of each member of XrCompositionLayerPassthroughANDROID, in order.
#define XR_LIST_STRUCT_XrCompositionLayerPassthroughANDROID(_) \
    _(type) \
    _(next) \
    _(layerFlags) \
    _(space) \
...
/// Calls your macro with the name of each member of XrSystemPassthroughLayerPropertiesANDROID, in order.
#define XR_LIST_STRUCT_XrSystemPassthroughLayerPropertiesANDROID(_) \
    _(type) \
    _(next) \
    _(supportsPassthroughLayer) \
    _(maxMeshIndexCount) \
    _(maxMeshVertexCount) \
...
/// Calls your macro with the name of each member of XrPerformanceMetricsStateANDROID, in order.
#define XR_LIST_STRUCT_XrPerformanceMetricsStateANDROID(_) \
    _(type) \
    _(next) \
    _(enabled) \

/// Calls your macro with the name of each member of XrPerformanceMetricsCounterANDROID, in order.
#define XR_LIST_STRUCT_XrPerformanceMetricsCounterANDROID(_) \
    _(type) \
    _(next) \
    _(counterFlags) \
    _(counterUnit) \
...
/// Calls your macro with the name of each member of XrSystemEnvironmentRaycastPropertiesMETA, in order.
#define XR_LIST_STRUCT_XrSystemEnvironmentRaycastPropertiesMETA(_) \
    _(type) \
    _(next) \
    _(supportsEnvironmentRaycast) \

/// Calls your macro with the name of each member of XrEnvironmentRaycasterCreateInfoMETA, in order.
#define XR_LIST_STRUCT_XrEnvironmentRaycasterCreateInfoMETA(_) \
    _(type) \
    _(next) \

/// Calls your macro with the name of each member of XrEnvironmentRaycasterCreateCompletionMETA, in order.
#define XR_LIST_STRUCT_XrEnvironmentRaycasterCreateCompletionMETA(_) \
    _(type) \
    _(next) \
    _(futureResult) \
    _(environmentRaycaster) \

/// Calls your macro with the name of each member of XrEnvironmentRaycastFilterBaseHeaderMETA, in order.
#define XR_LIST_STRUCT_XrEnvironmentRaycastFilterBaseHeaderMETA(_) \
    _(type) \
    _(next) \

/// Calls your macro with the name of each member of XrEnvironmentRaycastHitGetInfoMETA, in order.
#define XR_LIST_STRUCT_XrEnvironmentRaycastHitGetInfoMETA(_) \
    _(type) \
    _(next) \
    _(baseSpace) \
    _(time) \
...
/// Calls your macro with the name of each member of XrEnvironmentRaycastHitMETA, in order.
#define XR_LIST_STRUCT_XrEnvironmentRaycastHitMETA(_) \
    _(type) \
    _(next) \
    _(status) \
    _(pose) \

/// Calls your macro with the name of each member of XrEnvironmentRaycastFilterDistanceMETA, in order.
#define XR_LIST_STRUCT_XrEnvironmentRaycastFilterDistanceMETA(_) \
    _(type) \
    _(next) \
    _(maxDistance) \

/// Calls your macro with the name of each member of XrExtent3DiMETA, in order.
#define XR_LIST_STRUCT_XrExtent3DiMETA(_) \
    _(width) \
    _(height) \
    _(depth) \

/// Calls your macro with the name of each member of XrTilePropertiesMETA, in order.
#define XR_LIST_STRUCT_XrTilePropertiesMETA(_) \
    _(type) \
    _(next) \
    _(tileDimensions) \
    _(apronDimensions) \
...
/// Calls your macro with the name of each member of XrTilePropertiesHintMETA, in order.
#define XR_LIST_STRUCT_XrTilePropertiesHintMETA(_) \
    _(type) \
    _(next) \
    _(propertiesCount) \
    _(properties) \
...
/// Calls your macro with the name of each member of XrSystemQrCodeTrackingPropertiesANDROID, in order.
#define XR_LIST_STRUCT_XrSystemQrCodeTrackingPropertiesANDROID(_) \
    _(type) \
    _(next) \
    _(supportsQrCodeTracking) \
    _(supportsQrCodeSizeEstimation) \
    _(maxQrCodeCount) \

/// Calls your macro with the name of each member of XrTrackableQrCodeConfigurationANDROID, in order.
#define XR_LIST_STRUCT_XrTrackableQrCodeConfigurationANDROID(_) \
    _(type) \
    _(next) \
    _(trackingMode) \
    _(qrCodeEdgeSize) \

/// Calls your macro with the name of each member of XrTrackableQrCodeANDROID, in order.
#define XR_LIST_STRUCT_XrTrackableQrCodeANDROID(_) \
    _(type) \
    _(next) \
    _(trackingState) \
    _(lastUpdatedTime) \
...
/// Calls your macro with the name of each member of XrSystemSceneMeshingPropertiesANDROID, in order.
#define XR_LIST_STRUCT_XrSystemSceneMeshingPropertiesANDROID(_) \
    _(type) \
    _(next) \
    _(supportsSceneMeshing) \

/// Calls your macro with the name of each member of XrSceneMeshingTrackerCreateInfoANDROID, in order.
#define XR_LIST_STRUCT_XrSceneMeshingTrackerCreateInfoANDROID(_) \
    _(type) \
    _(next) \
    _(semanticLabelSet) \
    _(enableNormals) \

/// Calls your macro with the name of each member of XrSceneMeshSnapshotCreateInfoANDROID, in order.
#define XR_LIST_STRUCT_XrSceneMeshSnapshotCreateInfoANDROID(_) \
    _(type) \
    _(next) \
    _(baseSpace) \
    _(time) \
...
/// Calls your macro with the name of each member of XrSceneMeshSnapshotCreationResultANDROID, in order.
#define XR_LIST_STRUCT_XrSceneMeshSnapshotCreationResultANDROID(_) \
    _(type) \
    _(next) \
    _(snapshot) \
    _(trackingState) \

/// Calls your macro with the name of each member of XrSceneSubmeshStateANDROID, in order.
#define XR_LIST_STRUCT_XrSceneSubmeshStateANDROID(_) \
    _(type) \
    _(next) \
    _(submeshId) \
    _(lastUpdatedTime) \
    _(submeshPoseInBaseSpace) \
    _(bounds) \

/// Calls your macro with the name of each member of XrSceneSubmeshDataANDROID, in order.
#define XR_LIST_STRUCT_XrSceneSubmeshDataANDROID(_) \
    _(type) \
    _(next) \
    _(submeshId) \
    _(vertexCapacityInput) \
...
#define XR_LIST_STRUCT_XrSpatialCapabilityConfigurationObjectTrackingANDROID(_) \
    ...
    _(enabledComponentCount) \
    _(enabledComponents) \
    _(activeSemanticLabelCount) \
    _(activeSemanticLabels) \

/// Calls your macro with the name of each member of XrSpatialComponentObjectSemanticLabelListANDROID, in order.
#define XR_LIST_STRUCT_XrSpatialComponentObjectSemanticLabelListANDROID(_) \
    _(type) \
    _(next) \
    _(semanticLabelCount) \
    _(semanticLabels) \
...
/// Calls your macro with the name of each member of XrSpatialCapabilityConfigurationDepthRaycastANDROID, in order.
#define XR_LIST_STRUCT_XrSpatialCapabilityConfigurationDepthRaycastANDROID(_) \
    _(type) \
    _(next) \
    _(capability) \
    _(enabledComponentCount) \
...
/// Calls your macro with the name of each member of XrSpatialComponentRaycastResultListANDROID, in order.
#define XR_LIST_STRUCT_XrSpatialComponentRaycastResultListANDROID(_) \
    _(type) \
    _(next) \
...
/// Calls your macro with the name of each member of XrSpatialAnchorSpaceFromIdCreateInfoANDROID, in order.
...
/// Calls your macro with the name of each member of XrEventDataViewConfigurationViewsChangedEXT, in order.
#define XR_LIST_STRUCT_XrEventDataViewConfigurationViewsChangedEXT(_) \
    _(type) \
    _(next) \
    _(systemId) \
    _(viewConfigurationType) \
...
#define XR_LIST_STRUCTURE_TYPES_CORE(_) \
    ...
    _(XrSystemPropertiesBodyTrackingFidelityMETA, XR_TYPE_SYSTEM_PROPERTIES_BODY_TRACKING_FIDELITY_META) \
    _(XrBodyTrackingFidelityStatusMETA, XR_TYPE_BODY_TRACKING_FIDELITY_STATUS_META) \
    ...
    _(XrSoundObjectShapeSphereBD, XR_TYPE_SOUND_OBJECT_SHAPE_SPHERE_BD) \
    _(XrSoundObjectDistanceAttenuationCurveBD, XR_TYPE_SOUND_OBJECT_DISTANCE_ATTENUATION_CURVE_BD) \
    _(XrSoundObjectDistanceAttenuationBD, XR_TYPE_SOUND_OBJECT_DISTANCE_ATTENUATION_BD) \
    _(XrSoundObjectConfigBD, XR_TYPE_SOUND_OBJECT_CONFIG_BD) \
    _(XrSoundFieldConfigBD, XR_TYPE_SOUND_FIELD_CONFIG_BD) \
    _(XrSoundFieldChannelDefinitionSurroundBD, XR_TYPE_SOUND_FIELD_CHANNEL_DEFINITION_SURROUND_BD) \
    _(XrSoundFieldChannelDefinitionAmbixBD, XR_TYPE_SOUND_FIELD_CHANNEL_DEFINITION_AMBIX_BD) \
    _(XrSoundFieldChannelDefinitionFumaBD, XR_TYPE_SOUND_FIELD_CHANNEL_DEFINITION_FUMA_BD) \
    _(XrSoundTriangleMeshBD, XR_TYPE_SOUND_TRIANGLE_MESH_BD) \
    _(XrSoundObstacleConfigBD, XR_TYPE_SOUND_OBSTACLE_CONFIG_BD) \
    _(XrSoundObstacleMaterialConfigBD, XR_TYPE_SOUND_OBSTACLE_MATERIAL_CONFIG_BD) \
    ...
    _(XrSystemPassthroughLayerPropertiesANDROID, XR_TYPE_SYSTEM_PASSTHROUGH_LAYER_PROPERTIES_ANDROID) \
    _(XrRaycastInfoANDROID, XR_TYPE_RAYCAST_INFO_ANDROID) \
    _(XrRaycastHitResultsANDROID, XR_TYPE_RAYCAST_HIT_RESULTS_ANDROID) \
    _(XrPerformanceMetricsStateANDROID, XR_TYPE_PERFORMANCE_METRICS_STATE_ANDROID) \
    ...
    _(XrSystemEnvironmentRaycastPropertiesMETA, XR_TYPE_SYSTEM_ENVIRONMENT_RAYCAST_PROPERTIES_META) \
    _(XrEnvironmentRaycasterCreateInfoMETA, XR_TYPE_ENVIRONMENT_RAYCASTER_CREATE_INFO_META) \
    _(XrEnvironmentRaycasterCreateCompletionMETA, XR_TYPE_ENVIRONMENT_RAYCASTER_CREATE_COMPLETION_META) \
    _(XrEnvironmentRaycastHitGetInfoMETA, XR_TYPE_ENVIRONMENT_RAYCAST_HIT_GET_INFO_META) \
    _(XrEnvironmentRaycastHitMETA, XR_TYPE_ENVIRONMENT_RAYCAST_HIT_META) \
    ...
    _(XrSystemQrCodeTrackingPropertiesANDROID, XR_TYPE_SYSTEM_QR_CODE_TRACKING_PROPERTIES_ANDROID) \
    _(XrTrackableQrCodeConfigurationANDROID, XR_TYPE_TRACKABLE_QR_CODE_CONFIGURATION_ANDROID) \
    ...
    _(XrSystemSceneMeshingPropertiesANDROID, XR_TYPE_SYSTEM_SCENE_MESHING_PROPERTIES_ANDROID) \
    _(XrSceneMeshingTrackerCreateInfoANDROID, XR_TYPE_SCENE_MESHING_TRACKER_CREATE_INFO_ANDROID) \
    _(XrSceneMeshSnapshotCreateInfoANDROID, XR_TYPE_SCENE_MESH_SNAPSHOT_CREATE_INFO_ANDROID) \
    _(XrSceneMeshSnapshotCreationResultANDROID, XR_TYPE_SCENE_MESH_SNAPSHOT_CREATION_RESULT_ANDROID) \
    _(XrSceneSubmeshStateANDROID, XR_TYPE_SCENE_SUBMESH_STATE_ANDROID) \
    _(XrSceneSubmeshDataANDROID, XR_TYPE_SCENE_SUBMESH_DATA_ANDROID) \
...
#define XR_LIST_EXTENSIONS(_) \
    ...
    _(XR_META_body_tracking_fidelity, 285) \
    ...
    _(XR_QCOM_hand_tracking_gesture, 311) \
...
/// For every function defined by XR_META_body_tracking_fidelity in this version of the spec,
/// calls your macro with the function name and extension name.
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
#define XR_LIST_FUNCTIONS_XR_META_body_tracking_fidelity(_) \
    _(RequestBodyTrackingFidelityMETA, META_body_tracking_fidelity) \
...
/// For every function defined by XR_QCOM_hand_tracking_gesture in this version of the spec,
/// calls your macro with the function name and extension name.
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
#define XR_LIST_FUNCTIONS_XR_QCOM_hand_tracking_gesture(_) \
    _(GetHandGestureQCOM, QCOM_hand_tracking_gesture) \
...
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
#define XR_LIST_FUNCTIONS_XR_BD_spatial_audio_rendering(_) \
    _(EnumerateSupportedAudioSampleRateBD, BD_spatial_audio_rendering) \
    _(QueryFramesPerBufferRangeBD, BD_spatial_audio_rendering) \
    _(CreateSpatialAudioRendererBD, BD_spatial_audio_rendering) \
    _(DestroySpatialAudioRendererBD, BD_spatial_audio_rendering) \
    _(CreateSoundObstacleMaterialBD, BD_spatial_audio_rendering) \
    _(UpdateSoundObstacleMaterialConfigBD, BD_spatial_audio_rendering) \
    _(DestroySoundObstacleMaterialBD, BD_spatial_audio_rendering) \
    _(CreateSoundObstacleBD, BD_spatial_audio_rendering) \
    _(UpdateSoundObstacleConfigBD, BD_spatial_audio_rendering) \
    _(DestroySoundObstacleBD, BD_spatial_audio_rendering) \
    _(CreateSoundObjectBD, BD_spatial_audio_rendering) \
    _(UpdateSoundObjectConfigBD, BD_spatial_audio_rendering) \
    _(SubmitSoundObjectBufferBD, BD_spatial_audio_rendering) \
    _(DestroySoundObjectBD, BD_spatial_audio_rendering) \
    _(CreateSoundFieldBD, BD_spatial_audio_rendering) \
    _(UpdateSoundFieldConfigBD, BD_spatial_audio_rendering) \
    _(SubmitSoundFieldBufferBD, BD_spatial_audio_rendering) \
    _(DestroySoundFieldBD, BD_spatial_audio_rendering) \
    _(WaitAudioPeriodBD, BD_spatial_audio_rendering) \
...
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
#define XR_LIST_FUNCTIONS_XR_ANDROID_composition_layer_passthrough_mesh(_) \
    _(CreatePassthroughLayerANDROID, ANDROID_composition_layer_passthrough_mesh) \
    _(DestroyPassthroughLayerANDROID, ANDROID_composition_layer_passthrough_mesh) \
    _(SetPassthroughLayerMeshANDROID, ANDROID_composition_layer_passthrough_mesh) \
...
/// For every function defined by XR_ANDROID_performance_metrics in this version of the spec,
/// calls your macro with the function name and extension name.
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
#define XR_LIST_FUNCTIONS_XR_ANDROID_performance_metrics(_) \
    _(EnumeratePerformanceMetricsCounterPathsANDROID, ANDROID_performance_metrics) \
    _(SetPerformanceMetricsStateANDROID, ANDROID_performance_metrics) \
    _(GetPerformanceMetricsStateANDROID, ANDROID_performance_metrics) \
    _(QueryPerformanceMetricsCounterANDROID, ANDROID_performance_metrics) \
...
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
#define XR_LIST_FUNCTIONS_XR_META_environment_raycast(_) \
    _(CreateEnvironmentRaycasterAsyncMETA, META_environment_raycast) \
    _(CreateEnvironmentRaycasterCompleteMETA, META_environment_raycast) \
    _(DestroyEnvironmentRaycasterMETA, META_environment_raycast) \
    _(PerformEnvironmentRaycastMETA, META_environment_raycast) \


/// For every function defined by XR_META_tile_properties_hint in this version of the spec,
/// calls your macro with the function name and extension name.
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
...
/// For every function defined by XR_ANDROID_trackables_qr_code in this version of the spec,
/// calls your macro with the function name and extension name.
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
#define XR_LIST_FUNCTIONS_XR_ANDROID_trackables_qr_code(_) \
    _(GetTrackableQrCodeANDROID, ANDROID_trackables_qr_code) \
...
/// For every function defined by XR_ANDROID_scene_meshing in this version of the spec,
/// calls your macro with the function name and extension name.
/// Trims the leading `xr` from the function name and the leading `XR_` from the feature name,
/// because it is easy to add back but impossible to remove with the preprocessor.
#define XR_LIST_FUNCTIONS_XR_ANDROID_scene_meshing(_) \
    _(EnumerateSupportedSemanticLabelSetsANDROID, ANDROID_scene_meshing) \
    _(CreateSceneMeshingTrackerANDROID, ANDROID_scene_meshing) \
    _(DestroySceneMeshingTrackerANDROID, ANDROID_scene_meshing) \
    _(CreateSceneMeshSnapshotANDROID, ANDROID_scene_meshing) \
    _(DestroySceneMeshSnapshotANDROID, ANDROID_scene_meshing) \
    _(GetAllSubmeshStatesANDROID, ANDROID_scene_meshing) \
    _(GetSubmeshDataANDROID, ANDROID_scene_meshing) \
