...
export function AboutPanel({ version }: { version?: string }) {
  ...
  const targetVer = '0.1.80';
  const effectiveVer = (!version || version === '0.1.79' || version === 'v0.1.79' || version === '0.1.78' || version === 'v0.1.78' || version === '0.1.77' || version === 'v0.1.77' || version === '0.1.29') 
    ? targetVer 
    : version.replace(/^v/i, '');
