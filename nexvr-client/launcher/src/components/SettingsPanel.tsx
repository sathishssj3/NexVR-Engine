...
export function SettingsPanel({ config, onChange }: { config: VRConfig, onChange: (c: VRConfig) => void }) {
  ...
  return (
    <div className="fade-in-up stagger-2" style={{ flexShrink: 0, marginBottom: 30 }}>
      <div className="section-header">VR SETTINGS</div>
        ...
        <div className="glass-card" style={{ padding: '20px 24px' }}>
          ...
          <div className="setting-row" style={{ borderBottom: '1px solid rgba(255,255,255,0.03)', paddingTop: 0 }}>
            <div className="setting-label">
              ...
              <span className="desc">Render at native headset display clarity</span>
            </div>
          ...
          <div className="setting-row" style={{ borderBottom: '1px solid rgba(255,255,255,0.03)' }}>
            <div className="setting-label">
              ...
              <span className="desc">Optimize colors for VR lenses</span>
            </div>
          ...
          <div className="setting-row">
            <div className="setting-label">
              <span className="title">Depth Smoothing</span>
              <span className="desc">Improve motion smoothness and reduce lag</span>
            </div>
        ...
        <div className="glass-card" style={{ padding: '20px 24px' }}>
          ...
          <div className="setting-row" style={{ borderBottom: '1px solid rgba(255,255,255,0.03)', paddingTop: 0, flexDirection: 'column' as const, alignItems: 'stretch' as const, gap: 12 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div className="setting-label">
                <span className="title">Head Tracking Sensitivity</span>
                <span className="desc">Adjust head motion response speed</span>
              </div>
              <span style={{ fontFamily: 'var(--ag-font-mono)', color: 'var(--ag-accent)', fontSize: 18, fontWeight: 'bold', minWidth: 40, textAlign: 'right' as const }}>{config.motionAimSensitivity.toFixed(1)}</span>
            </div>
            <input 
          ...
          <div className="setting-row" style={{ borderBottom: '1px solid rgba(255,255,255,0.03)' }}>
            <div className="setting-label">
              <span className="title">Direct Input Mode</span>
              <span className="desc">Lower controller latency for faster response</span>
            </div>
          ...
          <div className="setting-row">
            <div className="setting-label">
              ...
              <span className="desc">Automatically launch in VR when game starts</span>
            </div>
