...
test.describe('Cross-game isolation and profile safety regression tests', () => {
  ...
  test('v0.1.58 high-reliability architecture: SEH crash boundaries, AC tripwire, and sync tooling', () => {
    ...
    expect(pkgJson.version).toBe('0.1.78');
  });

  test('v0.1.78 in-headset VR dashboard, obsidian glassmorphism UI, Apple design motion, and launcher synchronization', () => {
    ...
    expect(versionHeader).toContain('#define NEXVR_ENGINE_VERSION "0.1.78"');
