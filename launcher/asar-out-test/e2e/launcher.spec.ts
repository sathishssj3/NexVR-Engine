...
test.describe('Launcher E2E Tests', () => {
  ...
  test('should render the top bar with ANTIGRAVITY title', async () => {
    const title = window.locator('strong:has-text("ANTIGRAVITY")');
    await expect(title).toBeVisible();
    
    const version = window.locator('span:has-text("v1.0")');
